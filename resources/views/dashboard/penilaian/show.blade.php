        ...
        <form class="mb-5">
            ...
            <div class="mb-3">
                ...
                <select class="form-control @error('k16') is-invalid @enderror" name="k16" id="k16" required
                    disabled>
                    <option value="" selected @if (old('k16', $penilaian->k16) == '') selected="selected" @endif>-pilih-
                    </option>
            ...
            <div class="mb-3">
                <label for="k17" class="form-label">Pelaksanaan fasilitasi yang jadi kewenangan camat</label>
                <select class="form-control @error('k17') is-invalid @enderror" name="k17" id="k17" required
                    disabled>
                    <option value="" selected @if (old('k17', $penilaian->k17) == '') selected="selected" @endif>-pilih-
                    </option>
                    <option value="100" @if (old('k17', $penilaian->k17) == '100') selected="selected" @endif>> 15x dalam
                        setahun</option>
                    <option value="80" @if (old('k17', $penilaian->k17) == '80') selected="selected" @endif>≤ 15x dalam
                        setahun</option>
                </select> @error('k17')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            ...
            <div class="mb-3">
                ...
                <select class="form-control @error('k18') is-invalid @enderror" name="k18" id="k18" required
                    disabled>
                    <option value="" selected @if (old('k18', $penilaian->k18) == '') selected="selected" @endif>-pilih-
                    </option>
            ...
            <div class="mb-3">
                ...
                <select class="form-control @error('k21') is-invalid @enderror" name="k21" id="k21" required
                    ...
                    <option value="100" @if (old('k21', $penilaian->k21) == '100') selected="selected" @endif>Ada inovasi
                        baru
                        di tahun 2020 dan atau 2021</option>
                    <option value="0" @if (old('k21', $penilaian->k21) == '0') selected="selected" @endif>Tidak ada
                        inovasi baru di tahun 2020 dan atau 2021</option>
                </select> @error('k21')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            <div class="mb-3">
                ...
                <select class="form-control @error('k22') is-invalid @enderror" name="k22" id="k22" required
                    ...
                    <option value="100" @if (old('k22', $penilaian->k22) == '100') selected="selected" @endif>Ada</option>
            ...
            <div class="mb-3">
                ...
                <select class="form-control @error('k23') is-invalid @enderror" name="k23" id="k23" required
                    ...
                    <option value="100" @if (old('k23', $penilaian->k23) == '100') selected="selected" @endif>Ada</option>
